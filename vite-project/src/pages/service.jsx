...
const services = [
  {
    ...
    fullDesc:
      "We guarantee to sell your home at a pre-agreed price and timeframe. If we fail to do so, we will buy it ourselves. This gives you complete confidence, removes uncertainty, and ensures you never get stuck waiting for the right buyer.",
  ...
  },
  {
    ...
    fullDesc:
      "Receive multiple verified cash offers on your home within 72 hours. No long waiting periods, no complicated negotiations.",
  ...
  },
  {
    ...
    fullDesc:
      "Our smart home evaluation tool gives you an accurate and real-time market price of your property.",
  ...
  },
  {
    ...
    fullDesc:
      "We guarantee the sale of your current home so you can confidently purchase your next one.",
...
const Services = () => {
  ...
  // 🔥 Fetch banner image uploaded by admin
  useEffect(() => {
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mt-24">
            ...
            <p className="text-gray-500 mt-4 max-w-2xl mx-auto">
              ...
              security, speed, and transparency in every deal.
            </p>
